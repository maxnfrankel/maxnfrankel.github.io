...
![Group photo](/pages/images/GroupPhoto.jpg){: .center style="float: none" width="60%" }
<center>
...
<div class="row">
  <div class="column1">
    <img src="/pages/images/AxelPresentation.jpg" alt="Artist presentation" style="width:100%">
  </div>
  <div class="column2">
    <img src="/pages/images/CenkPresi.jpg" alt="Researcher presentation" style="width:100%">
  </div>
</div>
<center>
...
![KKH Professors visit Testalab](/pages/images/ProfsVisit.jpg){: .center style="float: none" width="60%" }
<center>
...
![Flyer for program](/pages/images/ArtAndScienceflyer.png){: .center style="float: center" width="70%" }
